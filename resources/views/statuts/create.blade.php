...
@section('breadcrumb')
  {{ Breadcrumbs::render('statuts.create') }}
@endsection
    ...
    <div class="card m-b-30">
      <div class="card-body">
        <h4 class="mt-0 header-title">Nouveau</h4>
          <p class="text-muted m-b-30 font-14">Créer un nouveau <code class="highlighter-rouge">Statut</code> dans le Système.</p>

          <form action="{{ route('statuts.store') }}" method="POST" enctype="multipart/form-data">
